...
<body>
    <nav class="navbar navbar-expand-md bg-body py-3">
        <div class="container"><a class="navbar-brand d-flex align-items-center"
                href="<?php echo base_url('activities/index') ?>"><span
                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-8">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        <h2 class="text-center mb-4" style="color: var(--bs-emphasis-color);">Work Log
                                        </h2>
                                        <?php echo validation_errors(); ?>
                                        <?php echo form_open(site_url("activities/update")); ?>
                                        <label class="form-label"
                                            style="color: var(--bs-emphasis-color);">Description&nbsp;<span
                                                style="color: rgb(255,16,1);">*</span></label>
                                        <div class="mb-3">
                                            <input value="<?php echo $activity['id'] ?>" type="text" name="activity_id"
                                                hidden>
                                            <textarea class="form-control" id="aktivitas" name="aktivitas" rows="6"
                                                placeholder="Isi Deskripsi dengan minimal 20 karakter" minLength=20
                                                maxLength=100 required><?php echo $activity['aktivitas'] ?></textarea>
                                        </div>
                                        <label class="form-label"
                                            style="color: var(--bs-emphasis-color);">Date&nbsp;<span
                                                style="color: rgb(255,16,1);">*</span></label>
                                        <input class="form-control" value="<?php echo $activity['tanggal'] ?>"
                                            type="date" name="tanggal" id="tanggal" style="margin-bottom: 18px;"
                                            required>

                                        <div class="row">

                                            <div class="col"><label class="form-label"
                                                    style="color: var(--bs-emphasis-color);">Time Start&nbsp;<span
                                                        style="color: rgb(255,16,1);">*</span></label>
                                                <h1></h1>

                                                <input class="form-control"
                                                    value="<?php echo $activity['waktu_mulai'] ?>" type="time"
                                                    name="waktu_mulai" id="waktu_mulai" required />
                                            </div>

                                            <div class="col"><label class="form-label"
                                                    style="color: var(--bs-emphasis-color);">Time End&nbsp;<span
                                                        style="color: rgb(255,16,1);">*</span></label>
                                                <h1></h1>

                                                <input class="form-control"
                                                    value="<?php echo $activity['waktu_akhir'] ?>" type="time"
