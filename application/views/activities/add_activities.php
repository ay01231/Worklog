                            ...
                            <div class="col-md-8 col-lg-6 col-xl-5 col-xxl-8">
                                <div class="card mb-5">
                                    <div class="card-body p-sm-5">
                                        ...
                                        <div class="mb-3"><textarea class="form-control" id="message-2" name="aktivitas"
                                                rows="6" placeholder="Isi Deskripsi dengan minimal 20 karakter"
                                                minLength=20 maxLength=100 required></textarea></div>
                                        <label class="form-label"
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                <label class="form-label" style="color: var(--bs-emphasis-color);">Time
                                                    Start&nbsp;<span style="color: rgb(255,16,1);">*</span></label>
                                                <input class="form-control" name="waktu_mulai" required type="time" />
                                            </div>
                                            <div class="col">
                                                <label class="form-label" style="color: var(--bs-emphasis-color);">Time
                                                    End&nbsp;<span style="color: rgb(255,16,1);">*</span></label>
