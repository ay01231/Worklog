...
<body id="page-top">
    ...
    <div id="wrapper" class="linear-gradient">
        <div class="d-flex flex-column" id="content-wrapper">
            <div id="content" class="linear-gradient">
                <div class="container-fluid">
                    <div class="text-center mt-5" style="background: #ffffff;margin-bottom: 50px;padding: 25px;">
